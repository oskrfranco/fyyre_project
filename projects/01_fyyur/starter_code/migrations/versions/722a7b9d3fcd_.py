...
Revision ID: 722a7b9d3fcd
Revises: 
Create Date: 2021-03-23 15:52:57.916769
...
def upgrade():
    ...
    sa.Column('looking_for_description', sa.String(length=500), nullable=True),
